...
<body>
    ...
    $sql = "SELECT * FROM product WHERE productname LIKE '%$keyword%' ORDER BY productid ASC";
...
?>
    <div class="container mt-3">
        ...
        ?>
            <div class="col-md-4">
                <div class="card">
                    <img src="images/<?= $row['inmage'] ?>" class="card-img-top" alt="<?= $row['productname'] ?>"
                    ...
                    <div class="card-body">
                        ...
                        <a href="cart.php?pid=<?= $row['productid'] ?>" class="btn btn-primary">Add to Cart</a>
                    </div>
                </div>
            </div>
            <?php
